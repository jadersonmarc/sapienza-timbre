...
//
// O estorno carrega estado porque os modos de falha dele importam: devolução repetida,
// devolução concorrente na mesma cobrança e recusa do gateway. Sem poder ensaiar isso sem
// rede, o caminho mais caro do estorno ficaria sem teste.
...
func (*FakeGateway) HandleWebhook(_ context.Context, payload []byte) (WebhookEvent, error) {
	...
	return WebhookEvent{
		...
		Confirmed: e.Confirmed, Refunded: e.Refunded, RefundKeys: e.RefundKeys,
	}, nil
}
